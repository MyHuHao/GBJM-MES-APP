...
class MaterialReceivingShockEnginesPage extends StatefulWidget {
  const MaterialReceivingShockEnginesPage({super.key});

  @override
  MaterialReceivingShockEnginesPageState createState() => MaterialReceivingShockEnginesPageState();
}

class MaterialReceivingShockEnginesPageState extends State<MaterialReceivingShockEnginesPage> with WidgetsBindingObserver {
